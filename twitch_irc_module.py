...
class TwitchChatIRC:
    ...
    def __init__(self):
        ...
        self.__NICK = "junmini7"
        self.__PASS = "oauth:7v59yuth2jb0zun41kxfu1tbdwikbp"
    ...
    def __print_message(self, message):
        print(
            ...
            emoji.demojize(message["message"])
            .encode("utf-8")
            .decode("utf-8", "ignore"),
        )
                ...
                try:
                    ...
                    if timeout != None:
                        ...
                        if time_since_last_message >= timeout:
                            print(
                                "No data received in", timeout, "seconds. Timing out."
                            )
                            break
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--send", action="store_true", help="send mode (default: False)"
    )
    parser.add_argument(
        "-output",
        "-o",
        default=None,
        help="output file (default: None = print to standard output)",
    )
